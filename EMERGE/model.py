...
class Encoder_overall(Module):
    ...
    def forward(self, features_omics1, features_omics2, adj_spatial_omics1, adj_feature_omics1, adj_spatial_omics2, adj_feature_omics2, epoch_id):
        # omics1
        emb_latent_spatial_omics1, _ = self.encoder_omics1(features_omics1, adj_spatial_omics1)  
        emb_latent_feature_omics1, _ = self.encoder_omics1(features_omics1, adj_feature_omics1)

        # omics2
        emb_latent_spatial_omics2, _ = self.encoder_omics2(features_omics2, adj_spatial_omics2)
        ...
        emb_recon_spa_omics1 = self.decoder_omics1(emb_latent_combined, adj_spatial_omics1)
        emb_recon_spa_omics2 = self.decoder_omics2(emb_latent_combined, adj_spatial_omics2)

        # consistency encoding
        emb_latent_spa_omics1_across_recon, _ = self.encoder_omics2(self.decoder_omics2(emb_latent_omics1, adj_spatial_omics2), adj_spatial_omics2) 
        emb_latent_spa_omics2_across_recon, _ = self.encoder_omics1(self.decoder_omics1(emb_latent_omics2, adj_spatial_omics1), adj_spatial_omics1) 

        results = {'emb_latent_omics1':emb_latent_omics1,
                   'emb_latent_omics2':emb_latent_omics2,
                   'emb_latent_combined':emb_latent_combined,
                   'emb_recon_spa_omics1':emb_recon_spa_omics1,
                   'emb_recon_spa_omics2':emb_recon_spa_omics2,
                   'emb_latent_omics1_across_recon':emb_latent_spa_omics1_across_recon,
                   'emb_latent_omics2_across_recon':emb_latent_spa_omics2_across_recon,
...
class Encoder(Module):
    def __init__(self, in_feat, out_feat, reduction=8, dropout=0.0, act=F.relu):
    ...
    def forward(self, feat, adj):
        x_weighted = feat
        x = torch.mm(x_weighted, self.weight)
        x = torch.spmm(adj, x)
        return x, x_weighted
